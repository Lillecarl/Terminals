...
namespace Terminals.Connections
{
    internal class WinBoxConnection : Connection, IFocusable
    {
        ...
        public override bool Connect()
        {
            ...
            // Timer is needed to reattach WinBox when it somehow changes MainWindow
            timer.Interval = 1000;
        ...
        private void LaunchWinBoxProcess()
        {
            ...
            try
            {
                ...
                // If WinBox was installed with chocolatey it'll have a shim and we can't wait for it for "awhile"
                try
                {
        ...
        public void AttachWinBox()
        {
            ...
            if (Methods.GetParent(NewHandle) != this.Handle && windowplacement.ShowCmd == ShowWindowCommands.Normal)
            {
                ...
                this.AdjustWindowStyle(WinBoxWindow);
